...
export default function PriceNegotiationPage() {
    ...
    const onBookRide = async () => {
        ...
        try {
            ...
            const ridePayload = { rideId: ride.id, pickup, destination, vehicleType: payload.vehicle_type, offerPrice };
...
'''
with codecs.open('src/pages/app/PriceNegotiationPage.tsx', 'w', 'utf-8') as f:
    f.write(content)
